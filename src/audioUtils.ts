...
const getAllChordSets = () => {
    ...
    let dimTypes = [dimSet, halfDimSet, fullDimSet];
    ...
    let minMajTypes = [minMajSet, minMaj9Set, minMaj9b13Set];
    ...
    let augTypes = [augSet, aug7Set, augMaj7Set];
